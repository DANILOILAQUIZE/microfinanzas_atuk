...
@section('header')
    <h2 class="page-title">Nuevo Tipo de Préstamo</h2>
    <div class="text-muted">Crea un nuevo producto crediticio</div>
@endsection
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('interes') is-invalid @enderror" 
                                   name="interes" value="{{ old('interes') }}" 
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                                      ...
                                      placeholder="Descripción del tipo de préstamo...">{{ old('descripcion') }}</textarea>
                            @error('descripcion')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('monto_minimo') is-invalid @enderror" 
                                   name="monto_minimo" value="{{ old('monto_minimo') }}" 
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('monto_maximo') is-invalid @enderror" 
                                   name="monto_maximo" value="{{ old('monto_maximo') }}" 
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('plazo_minimo') is-invalid @enderror" 
                                   name="plazo_minimo" value="{{ old('plazo_minimo') }}" 
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('plazo_maximo') is-invalid @enderror" 
                                   name="plazo_maximo" value="{{ old('plazo_maximo') }}" 
                        ...
                        <div class="col-12">
                            <label class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="requiere_garantia" 
                                       value="1" {{ old('requiere_garantia') ? 'checked' : '' }}>
